...
export const WorkFlowItem: React.FC<WorkflowItemProps> = ({ step, isOpen, isActive, onToggle }) => {
    return (
        <div
          ...
          ${isActive ? 'bg-[#E5FFB3]' : 'bg-gray-100'}`}>
            <button onClick={onToggle} className="w-full flex items-center justify-between p-6 text-left">
                <div className="flex items-center gap-4">
                    <span className="text-2xl font-medium">{String(step.id).padStart(2, '0')}</span>
